    ...
    return(
        <div className="atalhos">
            ...
            <div className="atalhos-box">
                ...
                <div className='atalho-comum'><div className='icons-div'><MdOutlineImportantDevices className='icons' /><span className='title'>Gerenciar acesso e aparelhos</span></div><MdChevronRight className='icone-gerenciar' /></div>
